...
public class WorldProviderEgypt extends WorldProvider
{
	private float[] colorsSunriseSunset = new float[4];
	public void registerWorldChunkManager()
	{
		this.worldChunkMgr = new WorldChunkManagerHell(Myths.TutorialBiome, this.dimensionId, this.dimensionId);
		this.dimensionId = Myths.DimID;
		this.hasNoSky = false;
	}
	public IChunkProvider createChunkGenerator()
	{
		return new ChunkProvider(this.worldObj, this.worldObj.getSeed(), false);
	}
	...
	{
		if ((this instanceof WorldProviderEgypt))
		{
			return "Entering Ancient Egypt...";
		}
		return null;
	}
	@SideOnly(Side.CLIENT)
	...
	{
	         return this.worldObj.getWorldVec3Pool().getVecFromPool(1, 0, 0);
	}
