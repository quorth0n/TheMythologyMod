...
public class ChunkProvider implements IChunkProvider
{
	...
	public ChunkProvider(World par1World, long par2, boolean par4) {
				...
				for (int k1 = 0; k1 < b1; ++k1)
				{
					...
					for (int l1 = 0; l1 < 8; ++l1)
					{
						...
						for (int i2 = 0; i2 < 4; ++i2)
						{
							...
							//		par3ArrayOfByte[j2 += short1] = (byte)Myths.Limestone.blockID;//
								}
								else if (k1 * 8 + l1 < b2)
								{
			...
			for (int var9 = 0; var9 < 16; var9++)
			{
				...
				for (int var16 = 127; var16 >= 0; var16--)
				{
					...
					else
					{
						...
						*//** Main filler block fill's all the underground, replaces block stone **//*
						else if (var18 != Myths.Limestone.blockID)
						{
							if (var13 == -1)
							{
								if (var12 == 0)
								{
									...
									*//** change to custom dirt **//*
									var15 = (byte)Myths.TutorialDirt.blockID;//
								}
							...
							else if (var13 > 0)
							{
								var13--;
								par3ArrayOfByte[var17] = var15;
								if ((var13 == 0) && (var15 == Block.grass.blockID))
								{
