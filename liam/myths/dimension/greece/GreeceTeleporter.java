/*package liam.myths.dimension.greece;
...
public class GreeceTeleporter extends Teleporter
{
	...
	*//**
	...
	public GreeceTeleporter(WorldServer par1WorldServer)
	{
	...
	*//**
	...
	public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
	{
		...
		else
		{
			for (k1 = l - short1; k1 <= l + short1; ++k1)
			{
				...
				for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1)
				{
					...
					{
						*//** change this block **//*
						if (this.worldServerInstance.getBlockId(k1, i2, l1) == Myths.GreecePortal.blockID)
						{
							*//** change this block **//*
							while (this.worldServerInstance.getBlockId(k1, i2 - 1, l1) == Myths.GreecePortal.blockID)
							{
								--i2;
							}
		...
		if (d3 >= 0.0D)
		{
			...
			int j2 = -1;
			*//** change this block **//*
			if (this.worldServerInstance.getBlockId(i - 1, j, k) == Myths.GreecePortal.blockID)
			{
				j2 = 2;
			}
			*//** change this block **//*
			...
			*//** change this block **//*
			if (this.worldServerInstance.getBlockId(i, j, k - 1) == Myths.GreecePortal.blockID)
			{
				j2 = 3;
			}
			*//** change this block **//*
		...
		for (k2 = 0; k2 < 4; ++k2)
		{
			for (i3 = 0; i3 < 4; ++i3)
			{
				for (l2 = -1; l2 < 4; ++l2)
				{
					...
					*//** change these blocks **//*
					this.worldServerInstance.setBlock(k3, j3, i4, flag ? Block.blockNetherQuartz.blockID : Myths.GreecePortal.blockID, 0, 2);
				}
			}
			for (i3 = 0; i3 < 4; ++i3)
			{
