...
public class RenderMummy extends RenderLiving
{
	...
	public RenderMummy(ModelBiped par1ModelBiped, float par2, float par3)
	{
	...
	protected int func_130006_a(EntityMummy par1EntityLiving, int par2, float par3)
	{
	...
	protected void func_130013_c(EntityMummy par1EntityLiving, int par2, float par3)
	{
		ItemStack itemstack = par1EntityLiving.func_130225_q(3 - par2);
	...
	public void doRenderLiving(EntityMummy par1EntityLiving, double par2, double par4, double par6, float par8, float par9)
	{
		float f2 = 1.0F;
	...
	protected ResourceLocation func_110856_a(EntityMummy par1EntityZeus)
	{
		return null;
	}

	protected void func_82420_a(EntityMummy par1EntityLiving, ItemStack par2ItemStack)
	{
	...
	protected void func_130005_c(EntityMummy par1EntityLiving, float par2)
	{
		float f1 = 1.0F;
		GL11.glColor3f(f1, f1, f1);
	...
	{
		this.func_130013_c((EntityMummy)par1EntityLivingBase, par2, par3);
	}
	...
	{
		return this.func_130006_a((EntityMummy)par1EntityLivingBase, par2, par3);
	}

	protected void renderEquippedItems(EntityLivingBase par1EntityLivingBase, float par2)
	{
		this.func_130005_c((EntityMummy)par1EntityLivingBase, par2);
	}

	public void renderPlayer(EntityLivingBase par1EntityLivingBase, double par2, double par4, double par6, float par8, float par9)
	{
		this.doRenderLiving((EntityMummy)par1EntityLivingBase, par2, par4, par6, par8, par9);
	}
	...
	{
		this.doRenderLiving((EntityMummy)par1Entity, par2, par4, par6, par8, par9);
	}
}