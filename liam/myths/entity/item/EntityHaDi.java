...
public class EntityHaDi extends EntityThrowable{
	 	public EntityHaDi(World par1World)
	    {
	        super(par1World);
	    }

	    public EntityHaDi(World par1World, EntityLivingBase par2EntityLivingBase)
	    {
	        super(par1World, par2EntityLivingBase);
	    }

	    @SideOnly(Side.CLIENT)
	    public EntityHaDi(World par1World, double par2, double par4, double par6)
	    {
