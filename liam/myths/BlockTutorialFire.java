...
public class BlockTutorialFire extends BlockFire
{
	...
	public BlockTutorialFire(int par1)
	{
		...
		this.func_111022_d("mythologymod:scarabTest");
	}
	...
	public void onBlockAdded(World par1World, int par2, int par3, int par4)
	{
		...
		if ((par1World.getBlockId(par2, par3 - 1, par4) != Block.sandStone.blockID) || (!Myths.TutorialPortal.tryToCreatePortal(par1World, par2, par3, par4)))
		{
			if ((!par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4)) && (!canNeighborBurn(par1World, par2, par3, par4)))
			{
				par1World.setBlockToAir(par2, par3, par4);
	...
	public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random)
	{
		...
		if ((!par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4)) && (!Myths.TutorialFire.canBlockCatchFire(par1World, par2, par3 - 1, par4, ForgeDirection.UP)))
		{
			if (Myths.TutorialFire.canBlockCatchFire(par1World, par2 - 1, par3, par4, ForgeDirection.EAST))
			{
				for (int l = 0; l < 2; l++)
				{
			...
			if (Myths.TutorialFire.canBlockCatchFire(par1World, par2 + 1, par3, par4, ForgeDirection.WEST))
			{
				for (int l = 0; l < 2; l++)
				{
			...
			if (Myths.TutorialFire.canBlockCatchFire(par1World, par2, par3, par4 - 1, ForgeDirection.SOUTH))
			{
				for (int l = 0; l < 2; l++)
				{
			...
			if (Myths.TutorialFire.canBlockCatchFire(par1World, par2, par3, par4 + 1, ForgeDirection.NORTH))
			{
				for (int l = 0; l < 2; l++)
				{
					float f = par2 + par5Random.nextFloat();
			...
			if (Myths.TutorialFire.canBlockCatchFire(par1World, par2, par3 + 1, par4, ForgeDirection.DOWN))
			{
				for (int l = 0; l < 2; l++)
				{
					float f = par2 + par5Random.nextFloat();
	...
	{
		this.iconArray = new Icon[] { par1IconRegister.registerIcon("mythologymod:Tutorialfire_0"), par1IconRegister.registerIcon("mytholohymod:Tutorialfire_1") };
	}
	@SideOnly(Side.CLIENT)
