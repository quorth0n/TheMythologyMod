...
public class ItemPortalPlacer extends Item
{
	public ItemPortalPlacer(int par1)
	{
		...
		this.func_111206_d("mythologymod:portalPlacer");
	}
	public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int X, int Y, int Z, int par7, float par8, float par9, float par10)
	{
		if (!par3World.isRemote)
		{
			...
			if ((direction == 1) || (direction == 3))
			{
				...
				par3World.setBlock(X, Y + 2, Z, Block.sandStone.blockID);
				par3World.setBlock(X + 1, Y + 2, Z, Block.sandStone.blockID);
				...
				par3World.setBlock(X + 2, Y + 3, Z, Block.sandStone.blockID);
				par3World.setBlock(X - 1, Y + 3, Z, Block.sandStone.blockID);
				par3World.setBlock(X + 3, Y + 4, Z, Block.blockEmerald.blockID);
				par3World.setBlock(X - 2, Y + 4, Z, Block.blockEmerald.blockID);
				par3World.setBlock(X + 2, Y + 4, Z, Block.sandStone.blockID);
				par3World.setBlock(X - 1, Y + 4, Z, Block.sandStone.blockID);
				par3World.setBlock(X + 3, Y + 5, Z, Block.blockEmerald.blockID);
				par3World.setBlock(X - 2, Y + 5, Z, Block.blockEmerald.blockID);
				par3World.setBlock(X + 2, Y + 5, Z, Block.sandStone.blockID);
				par3World.setBlock(X - 1, Y + 5, Z, Block.sandStone.blockID);
				...
				par3World.setBlock(X, Y + 6, Z, Block.sandStone.blockID);
				par3World.setBlock(X + 1, Y + 6, Z, Block.sandStone.blockID);
